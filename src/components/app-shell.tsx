        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="flex w-full items-center gap-3 rounded-xl px-2 py-2 text-left transition-colors hover:bg-accent">
              <span className="grid size-9 place-items-center rounded-full bg-brand-indigo text-xs font-semibold text-white">AP</span>
              <span className="min-w-0 flex-1">
                <span className="block truncate text-[13px] font-medium">Alex Parker</span>
                <span className="block truncate text-[11px] text-muted-foreground">Executive Producer</span>
              </span>
