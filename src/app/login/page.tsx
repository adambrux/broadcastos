    ...
    <div className="grid min-h-screen place-items-center bg-background px-6">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h1 className="text-xl font-semibold tracking-tight">BroadcastOS</h1>
        ...
        {checked && (
          <form onSubmit={submit} className="space-y-4 rounded-2xl border border-border/70 bg-card p-6 shadow-sm">
            {needsSetup && (
              <label className="block">
                <span className="mb-1 block text-[13px] font-medium">Your name</span>
                <input
                  className="h-11 w-full rounded-xl border border-border bg-background px-3 text-[14px] outline-none focus:ring-2 focus:ring-brand-indigo/30"
                  value={displayName}
